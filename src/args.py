...
def parse_arguments():
    ...
    parser.add_argument("-a", "--arch", metavar="ARCH", default="van_base", help="model architecture")
    ...
    parser.add_argument('--data_url', default="/cache/dataset", help='location of data.')
    ...
    parser.add_argument("--epochs", default=310, type=int, metavar="N", help="number of total epochs to run")
    ...
    parser.add_argument("--end_length", default=300, type=int, help="number of decay iterations")
    parser.add_argument("--warmup_lr", default=1e-6, type=float, help="warm up learning rate")
    ...
    parser.add_argument("--config", help="Config file to use (see configs dir)",type=str, default='src/configs/van_base.yaml')
    parser.add_argument("--seed", default=1200, type=int, help="seed for initializing training. ")
